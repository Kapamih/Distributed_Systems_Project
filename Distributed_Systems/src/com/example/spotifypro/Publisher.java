...
public class Publisher extends Node {
    ...
    public static void main(String args[]) throws NoSuchAlgorithmException, InvalidDataException, IOException, UnsupportedTagException {
        Publisher pub=new Publisher('a', 'z', "192.168.1.4", 4090, "192.168.1.4", 2011);//kathe fora allazoyme to server port
    ...
    public void initialization() throws NoSuchAlgorithmException, IOException, InvalidDataException, UnsupportedTagException {

        for ( String a : readMp3Files.getPublisherArtistList(start, end)){
            ArtistName newArtist = new ArtistName(a);
            artists.add(newArtist);
        }
        song_to_art = readMp3Files.getHashSongs("src\\Songs",artists);
    ...
    //sends chunks to broker
    public void push(String requestSong, ObjectOutputStream out ) throws IOException, InvalidDataException, UnsupportedTagException {
